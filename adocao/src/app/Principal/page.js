                        ...
                        <div className="row">
                            <div className="col-lg-6 d-flex flex-column justify-content-center">
                                ...
                                <div data-aos="fade-up" data-aos-delay="600">
                                    <div className="comecar text-center text-lg-start">
                                        <a  onClick={() => router.push('/Animais')} style={{}} className="btn-get-started scrollto d-inline-flex align-items-center justify-content-center align-self-center">
                                            <span>Começar!</span>
